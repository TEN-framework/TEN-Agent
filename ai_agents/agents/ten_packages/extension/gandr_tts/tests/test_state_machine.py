...
def test_sequential_requests_state_machine(MockGandrTTSClient):
    """
    ...
    MockGandrTTSClient.return_value = mock_instance
...
@patch("gandr_tts.extension.GandrTTSClient")
def test_request_state_transitions(MockGandrTTSClient):
    """
