...
def test_dump_functionality(MockInworldTTSClient):
    ...
    tester.set_test_mode_single("inworld_tts_python", json.dumps(dump_config))
...
class ExtensionTesterFlush(ExtensionTester):
    def __init__(self):
        ...
        self.sample_rate = 16000  # matches tests/configs sample_rate
