...
[文档](https://doc.theten.ai/ten-agent/overview)
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
[快速开始](https://doc.theten.ai/ten-agent/getting_started)
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
...
[TEN Agent ESP32 客户端](https://github.com/TEN-framework/TEN-Agent/tree/main/esp32-client)
...
<br>
<h2>TEN Agent + Gemini 多模态实时 API</h2>
...
<br>
<h2>本地环境中的 TEN Agent Playground</h2>
...
现在，我们已经成功设置了 Playground。这只是 TEN Agent 的开始。还有许多不同的方式可以探索和利用 TEN Agent。要了解更多，请参阅 [文档](https://doc.theten.ai/ten-agent/overview)。
...
阅读 [部署指南](https://doc.theten.ai/ten-agent/deployment/deploy_agent_service) 以获取有关部署的详细信息。
...
在我们开始之前，请确保为我们的仓库加星，并获取所有新版本的即时通知！

![TEN 加星 gif](https://github.com/TEN-framework/docs/blob/main/assets/gif/star_us_2.gif?raw=true)

<br>
<h2>加入社区</h2>

- [Discord](https://discord.gg/VnPftUzAMJ)：适合分享您的应用程序并与社区互动。
- [GitHub 讨论](https://github.com/TEN-framework/ten-agent/discussions)：适合提供反馈和提问。
- [GitHub 问题](https://github.com/TEN-framework/ten-agent/issues)：最适合报告错误和提出新功能。有关更多详细信息，请参阅我们的 [贡献指南](./docs/code-of-conduct/contributing.md)。
- [X](https://img.shields.io/twitter/follow/TenFramework?logo=X&color=%20%23f5f5f5)：适合分享您的代理并与社区互动。

<br>
<h2>星标历史</h2>

[![星标历史图](https://api.star-history.com/svg?repos=ten-framework/ten-agent&type=Date)](https://star-history.com/#ten-framework/ten-agent&Date)
...
此项目根据 Apache 2.0 许可证授权 - 有关详细信息，请参阅 [LICENSE](LICENSE) 文件。
