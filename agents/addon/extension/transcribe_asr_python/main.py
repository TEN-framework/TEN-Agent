...
class TranscribeAsrExtension(Extension):
    ...
    def on_init(
        ...
        logger.info("TranscribeAsrExtension on_init")
    ...
    def on_pcm_frame(self, rte: Rte, pcm_frame: PcmFrame) -> None:
    ...
    def on_deinit(self, rte: Rte) -> None:
        logger.info("TranscribeAsrExtension on_deinit")
        rte.on_deinit_done()
...
class TranscribeAsrExtensionAddon(Addon):
    def on_init(self, rte: Rte, manifest, property) -> None:
        logger.info("TranscribeAsrExtensionAddon on_init")
        rte.on_init_done(manifest, property)
        return
    ...
    def on_deinit(self, rte: Rte) -> None:
        logger.info("TranscribeAsrExtensionAddon on_deinit")
        rte.on_deinit_done()
        return
