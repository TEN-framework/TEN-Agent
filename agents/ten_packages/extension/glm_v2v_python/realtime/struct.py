...
class BetaFieldsParams:
    chat_mode: ChatMode = ChatMode.Audio  # Chat mode for the session, defaulting to "audio"
...
class SessionUpdateParams:
    ...
    turn_detection: ServerVADUpdateParams = field(default_factory=ServerVADUpdateParams)  # VAD update parameters
    ...
    beta_fields: BetaFieldsParams = field(default_factory=BetaFieldsParams)  # Beta fields for additional settings
